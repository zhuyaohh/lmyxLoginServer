...
public class VerifyController {
    ...
    //公钥
    private static final String PUBLIC_KEY = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDAG/B5Ce6ECDtldcrhXlG7vGtxod+eoQ8//u2UOuuG7c2oZKEcMqVoKftITG8rWDjVK+2fDnaEJDll8apJNRCB9DIKtO+fPg7DhuG+u5n3gjlXGxx1fZXUiLa5LaTAQfEFAgd+O6yecnXWUnZEmBVDFdfIkaMFtlI0hCk4fyah9QIDAQAB";
    //IOS公钥
    private static final String IOS_PUBLIC_KEY = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDD5C3/+PUnJg7Aqfvp692sZaYHGtoDze4ShMur4E/YkU7gWJ/m9aW1cPl0fpLz9rAmz8mk3SG+Uh7FCg1gNZhosBbbtOFs2+hcky9z+aVg9M3Mw31lV55UqEBmxQEOuYaL6cCYp+gj+pup63Ljo+VG7Wctlm6MpdmU8qLXe4PlewIDAQAB";
    ...
    //从字符串加载公钥
    public static PublicKey loadIOSPublicKeyByStr() throws Exception {
        try {
            String publicKeyStr = "";
            
            int count = 0;
            for (int i = 0; i < IOS_PUBLIC_KEY.length(); ++i)
            {
            	if (count < 64)
            	{
            		publicKeyStr += IOS_PUBLIC_KEY.charAt(i);
            		count++;
            	}
            	else
            	{
    ...
    {  
        ...
        {  
        	...
        	logger.info("===========verifySign================"+bverify);
            return bverify;  
	...
	public static void main(String[] args) throws Exception {
		...
		try
		{
			...
			{
				System.out.print("sign_data_verify_failed");
				System.exit(0);
			}
			//解密
			...
			{
				System.out.print("encryp_data_decrypt_failed");
				System.exit(0);
			}
			/*********************************************************************
